<x-app-layout title="Sewa Bus Pariwisata | M-One Travella">
                ...
                <div class="container mx-auto px-4 md:px-12 ">
                    <div class="sm:flex justify-center grid place-items-center flex-wrap mb-5 -mx-1 lg:-mx-4">
                        <div class="grid grid-cols-1 place-items-center gap-5 md:grid-cols-2 lg:grid-cols-3">
                            <section
                                class="flex h-auto w-80 flex-col rounded-md border hover:bg-white transition-colors">
                                ...
                                <article class="px-5 py-5">
                                    <h1 class="text-gray-700 font-bold text-2xl mb-3">Hiace</h1>
                                    <div class="grid grid-cols-2 gap-5">
                                        ...
                                        <div class="bg-red-500">
                                            <a href="https://wa.link/4ti0bp"
                                                class="flex items-center justify-between bg-[#d5633c] px-2 py-3 text-sm w-40 rounded-md text-slate-50 hover:bg-[#843128] transition-all font-semibold">
                                                <span> Sewa Sekarang</span>
                                                <span><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" x="0px"
